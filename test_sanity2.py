...
#syötteesä liukuluku, jossa on useampi desimaalipilkku : virhe
...
def test_liukuluku_tekstia():
    assert sanity2.liukuluvuksi('sata') == [2, 'Syötteessä ylimäärisiä merkkejä: vain numerot ja desimaalipiste on sallittu' , .0]
